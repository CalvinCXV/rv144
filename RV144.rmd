...
The plot shows us that from 16,402 volunteers, two groups were made. One with volunteers carrying aids, and one without. In the aids group, 5 subjects returned with no aids after given the vaccine, while 2 subject returned with no aids after given a placebo.  
...
There is no relationship between getting aids and having taken the aids vaccine  
  
There is a relation between aids and having the aids vaccine  
...
While the vaccine has proven to have a positive effect, the probability of the vaccine working, is slim.